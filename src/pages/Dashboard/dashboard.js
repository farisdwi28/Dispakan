  ...
  return (
    <div className="flex page-container">
      ...
      <main className="flex-grow container mx-auto p-6">
        ...
        <div className="w-[1090px] h-[260px] bg-white rounded-lg drop-shadow-2xl flex">
          {/* statistik 1 */}
          <div class="w-[340px] h-[212px] bg-slate-300 rounded-lg border border border border border-pink-50 m-5 drop-shadow-xl">
            <img
              src={images.boxIcon}
          ...
          {/* statistik 2 */}
          <div class="w-[340px] h-[212px] bg-slate-300 rounded-lg border border border border border-indigo-50 m-5 drop-shadow-xl">
            <img
          ...
          {/* statistik 3 */}
          <div class="w-[340px] h-[212px] bg-slate-300 rounded-lg border border border border border-orange-50 m-5 drop-shadow-xl">
            <img
